...
#define electron_mass 0.00051099895000 // GeV/c2
...
TH1D *trueelectron_truemom_CCQE_GENIE;
TH1D *trueelectron_truemom_CCMEC_GENIE;
TH1D *trueelectron_truemom_CCRES_GENIE;
TH1D *trueelectron_truemom_CCDIS_GENIE;
TH1D *trueelectron_truemom_CCCOH_GENIE;
TH1D *trueelectron_truemom_other_GENIE;

////// true cosine of theta (angle with respect to the neutrino beam direction) of the true electron selected

TH1D *trueelectron_truecostheta_CCQE_GENIE;
TH1D *trueelectron_truecostheta_CCMEC_GENIE;
TH1D *trueelectron_truecostheta_CCRES_GENIE;
TH1D *trueelectron_truecostheta_CCDIS_GENIE;
TH1D *trueelectron_truecostheta_CCCOH_GENIE;
TH1D *trueelectron_truecostheta_other_GENIE;

////// true phi angle of the true electron selected (needs to double check. I want it from -pi to pi)

TH1D *trueelectron_truephi_CCQE_GENIE;
TH1D *trueelectron_truephi_CCMEC_GENIE;
TH1D *trueelectron_truephi_CCRES_GENIE;
TH1D *trueelectron_truephi_CCDIS_GENIE;
TH1D *trueelectron_truephi_CCCOH_GENIE;
TH1D *trueelectron_truephi_other_GENIE;
...
double GetEnuCCQE(double energy_electron, double cosine_electron, double p_electron){

    double Enum = (protonmass*energy_electron) - (electron_mass*electron_mass)/2.;
    double Eden = protonmass - energy_electron + (p_electron*cosine_electron);
...
double GetEnuRes(double energy_electron, double cosine_electron){

    double mdelta= 1.232;//delta mass GeV/c2
    double Enum = (mdelta*mdelta) - (protonmass*protonmass) + (2.*protonmass*energy_electron);
    double Eden = 2.*(protonmass-(energy_electron*(1.-cosine_electron)));
...
double GetQ2(double enu, double energy_electron, double p_electronz){ /// invariant 4-momentum transfer
    ...
    double mom4 = 2 * enu * (energy_electron - p_electronL) - electron_mass*electron_mass;
    return mom4;
...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    trueelectron_truemom_CCQE_GENIE = new TH1D("trueelectron_truemom_CCQE_GENIE", "trueelectron_truemom_CCQE_GENIE", 60, 0, 3);
    trueelectron_truemom_CCMEC_GENIE = new TH1D("trueelectron_truemom_CCMEC_GENIE", "trueelectron_truemom_CCMEC_GENIE", 60, 0, 3);
    trueelectron_truemom_CCRES_GENIE = new TH1D("trueelectron_truemom_CCRES_GENIE", "trueelectron_truemom_CCRES_GENIE", 60, 0, 3);
    trueelectron_truemom_CCDIS_GENIE = new TH1D("trueelectron_truemom_CCDIS_GENIE", "trueelectron_truemom_CCDIS_GENIE", 60, 0, 3);
    trueelectron_truemom_CCCOH_GENIE = new TH1D("trueelectron_truemom_CCCOH_GENIE", "trueelectron_truemom_CCCOH_GENIE", 60, 0, 3);
    trueelectron_truemom_other_GENIE = new TH1D("trueelectron_truemom_other_GENIE", "trueelectron_truemom_other_GENIE", 60, 0, 3);

    trueelectron_truecostheta_CCQE_GENIE = new TH1D("trueelectron_truecostheta_CCQE_GENIE", "trueelectron_truecostheta_CCQE_GENIE", 60, -1, 1);
    trueelectron_truecostheta_CCMEC_GENIE = new TH1D("trueelectron_truecostheta_CCMEC_GENIE", "trueelectron_truecostheta_CCMEC_GENIE", 60, -1, 1);
    trueelectron_truecostheta_CCRES_GENIE = new TH1D("trueelectron_truecostheta_CCRES_GENIE", "trueelectron_truecostheta_CCRES_GENIE", 60, -1, 1);
    trueelectron_truecostheta_CCDIS_GENIE = new TH1D("trueelectron_truecostheta_CCDIS_GENIE", "trueelectron_truecostheta_CCDIS_GENIE", 60, -1, 1);
    trueelectron_truecostheta_CCCOH_GENIE = new TH1D("trueelectron_truecostheta_CCCOH_GENIE", "trueelectron_truecostheta_CCCOH_GENIE", 60, -1, 1);
    trueelectron_truecostheta_other_GENIE = new TH1D("trueelectron_truecostheta_other_GENIE", "trueelectron_truecostheta_other_GENIE", 60, -1, 1);

    trueelectron_truephi_CCQE_GENIE = new TH1D("trueelectron_truephi_CCQE_GENIE", "trueelectron_truephi_CCQE_GENIE", 60, -3.15, 3.15);
    trueelectron_truephi_CCMEC_GENIE = new TH1D("trueelectron_truephi_CCMEC_GENIE", "trueelectron_truephi_CCMEC_GENIE", 60, -3.15, 3.15);
    trueelectron_truephi_CCRES_GENIE = new TH1D("trueelectron_truephi_CCRES_GENIE", "trueelectron_truephi_CCRES_GENIE", 60, -3.15, 3.15);
    trueelectron_truephi_CCDIS_GENIE = new TH1D("trueelectron_truephi_CCDIS_GENIE", "trueelectron_truephi_CCDIS_GENIE", 60, -3.15, 3.15);
    trueelectron_truephi_CCCOH_GENIE = new TH1D("trueelectron_truephi_CCCOH_GENIE", "trueelectron_truephi_CCCOH_GENIE", 60, -3.15, 3.15);
    trueelectron_truephi_other_GENIE = new TH1D("trueelectron_truephi_other_GENIE", "trueelectron_truephi_other_GENIE", 60, -3.15, 3.15);
...
///////////////////////////////////////////
    ...
    for (Long64_t jentry=0; jentry<nentries;jentry++) {
        ...
        double p_electron = sqrt(pxl*pxl + pyl*pyl + pzl*pzl); /// true electron (absolute) momentum
        double energy_electron = sqrt(electron_mass*electron_mass + p_electron*p_electron); /// true electron energy
        double q2 = GetQ2(Ev, energy_electron, pzl); /// 4-momentum transfer from true kinematics
        double omega = w(energy_electron, Ev); /// true energy transfer
        ...
        if(qel==true){
            ...
            //// true kinematics /////
            trueelectron_truemom_CCQE_GENIE->Fill(sqrt(pow(pxl,2)+ pow(pyl,2)+pow(pzl,2)), rw);
            trueelectron_truecostheta_CCQE_GENIE->Fill(cosine(pxl, pyl , pzl),rw);
            trueelectron_truephi_CCQE_GENIE->Fill(Getphi(pxl, pyl, pzl),rw);
            ...
            EnuCCQE_CCQE_GENIE->Fill(GetEnuCCQE(energy_electron, cosine(pxl, pyl , pzl), p_electron),rw);
            EnuCalo_CCQE_GENIE->Fill(GetEcalomiss(Esum, PTmiss, 0),rw);/// assuming 1electron + protons int eh final state, Ar40 (np=0)
            EnuRes_CCQE_GENIE->Fill(GetEnuRes(energy_electron, cosine(pxl, pyl , pzl)),rw);
            ...
            Resolution_EnuCCQE_GENIE->Fill(EvRF,EvRF - GetEnuCCQE(energy_electron, cosine(pxl, pyl , pzl), p_electron),rw);
            Resolution_EnuCalo_GENIE->Fill(EvRF,EvRF - GetEcalomiss(Esum, PTmiss, 0),rw);
            Resolution_EnuRes_GENIE->Fill(EvRF,EvRF - GetEnuRes(energy_electron, cosine(pxl, pyl , pzl)),rw);

            hprof_EnuCCQE_GENIE->Fill(EvRF,EvRF - GetEnuCCQE(energy_electron, cosine(pxl, pyl , pzl), p_electron),rw);
            hprof_EnuCalo_GENIE->Fill(EvRF,EvRF - GetEcalomiss(Esum, PTmiss, 0),rw);
            hprof_EnuRes_GENIE->Fill(EvRF,EvRF - GetEnuRes(energy_electron, cosine(pxl, pyl , pzl)),rw);

            hprof_EnuCCQE_GENIEnorw->Fill(EvRF,EvRF - GetEnuCCQE(energy_electron, cosine(pxl, pyl , pzl), p_electron),1);
            hprof_EnuCalo_GENIEnorw->Fill(EvRF,EvRF - GetEcalomiss(Esum, PTmiss, 0),1);
            hprof_EnuRes_GENIEnorw->Fill(EvRF,EvRF - GetEnuRes(energy_electron, cosine(pxl, pyl , pzl)),1);
            ...
            /// true kinematics /////
            trueelectron_truemom_CCMEC_GENIE->Fill(sqrt(pow(pxl,2)+ pow(pyl,2)+pow(pzl,2)),rw);
            trueelectron_truecostheta_CCMEC_GENIE->Fill(cosine(pxl, pyl , pzl),rw);
            trueelectron_truephi_CCMEC_GENIE->Fill(Getphi(pxl, pyl, pzl),rw);
            ...
            EnuCCQE_CCMEC_GENIE->Fill(GetEnuCCQE(energy_electron, cosine(pxl, pyl , pzl), p_electron),rw);
            EnuCalo_CCMEC_GENIE->Fill(GetEcalomiss(Esum, PTmiss, 0),rw);/// assuming 1electron + protons int eh final state, Ar40 (np=0)
            EnuRes_CCMEC_GENIE->Fill(GetEnuRes(energy_electron, cosine(pxl, pyl , pzl)),rw);
            ...
            ////// true kinematics /////
            trueelectron_truemom_CCRES_GENIE->Fill(sqrt(pow(pxl,2)+ pow(pyl,2)+pow(pzl,2)),rw);
            trueelectron_truecostheta_CCRES_GENIE->Fill(cosine(pxl, pyl , pzl),rw);
            trueelectron_truephi_CCRES_GENIE->Fill(Getphi(pxl, pyl, pzl),rw);
            ...
            EnuCCQE_CCRES_GENIE->Fill(GetEnuCCQE(energy_electron, cosine(pxl, pyl , pzl), p_electron),rw);
            EnuCalo_CCRES_GENIE->Fill(GetEcalomiss(Esum, PTmiss, 0),rw);/// assuming 1electron + protons int eh final state, Ar40 (np=0)
            EnuRes_CCRES_GENIE->Fill(GetEnuRes(energy_electron, cosine(pxl, pyl , pzl)),rw);
            ...
            //// true kinematics /////
            trueelectron_truemom_CCDIS_GENIE->Fill(sqrt(pow(pxl,2)+ pow(pyl,2)+pow(pzl,2)),rw);
            trueelectron_truecostheta_CCDIS_GENIE->Fill(cosine(pxl, pyl , pzl),rw);
            trueelectron_truephi_CCDIS_GENIE->Fill(Getphi(pxl, pyl, pzl),rw);
            ...
            EnuCCQE_CCDIS_GENIE->Fill(GetEnuCCQE(energy_electron, cosine(pxl, pyl , pzl), p_electron),rw);
            EnuCalo_CCDIS_GENIE->Fill(GetEcalomiss(Esum, PTmiss, 0),rw);/// assuming 1electron + protons int eh final state, Ar40 (np=0)
            EnuRes_CCDIS_GENIE->Fill(GetEnuRes(energy_electron, cosine(pxl, pyl , pzl)),rw);
            ...
            /// true kinematics /////
            trueelectron_truemom_CCCOH_GENIE->Fill(sqrt(pow(pxl,2)+ pow(pyl,2)+pow(pzl,2)),rw);
            trueelectron_truecostheta_CCCOH_GENIE->Fill(cosine(pxl, pyl , pzl),rw);
            trueelectron_truephi_CCCOH_GENIE->Fill(Getphi(pxl, pyl, pzl),rw);
            ...
            EnuCCQE_CCCOH_GENIE->Fill(GetEnuCCQE(energy_electron, cosine(pxl, pyl , pzl), p_electron),rw);
            EnuCalo_CCCOH_GENIE->Fill(GetEcalomiss(Esum, PTmiss, 0),rw);/// assuming 1electron + protons int eh final state, Ar40 (np=0)
            EnuRes_CCCOH_GENIE->Fill(GetEnuRes(energy_electron, cosine(pxl, pyl , pzl)),rw);
            ...
            ///// true kinematics /////
            trueelectron_truemom_other_GENIE->Fill(sqrt(pow(pxl,2)+ pow(pyl,2)+pow(pzl,2)),rw);
            trueelectron_truecostheta_other_GENIE->Fill(cosine(pxl, pyl , pzl),rw);
            trueelectron_truephi_other_GENIE->Fill(Getphi(pxl, pyl, pzl),rw);
            ...
            EnuCCQE_other_GENIE->Fill(GetEnuCCQE(energy_electron, cosine(pxl, pyl , pzl), p_electron),rw);
            EnuCalo_other_GENIE->Fill(GetEcalomiss(Esum, PTmiss, 0),rw);/// assuming 1electron + protons int eh final state, Ar40 (np=0)
            EnuRes_other_GENIE->Fill(GetEnuRes(energy_electron, cosine(pxl, pyl , pzl)),rw);
    ...
    trueelectron_truemom_CCQE_GENIE-> SetFillColor(kRed);
    trueelectron_truemom_CCMEC_GENIE-> SetFillColor(kGreen);
    trueelectron_truemom_CCRES_GENIE-> SetFillColor(kYellow);
    trueelectron_truemom_CCDIS_GENIE-> SetFillColor(kBlue);
    trueelectron_truemom_CCCOH_GENIE-> SetFillColor(kMagenta);

    THStack *trueelectron_truemom_GENIE = new THStack("trueelectron_truemom_GENIE","");
    trueelectron_truemom_GENIE-> Add(trueelectron_truemom_CCQE_GENIE);
    trueelectron_truemom_GENIE-> Add(trueelectron_truemom_CCMEC_GENIE);
    trueelectron_truemom_GENIE-> Add(trueelectron_truemom_CCRES_GENIE);
    trueelectron_truemom_GENIE-> Add(trueelectron_truemom_CCDIS_GENIE);
    trueelectron_truemom_GENIE-> Add(trueelectron_truemom_CCCOH_GENIE);
    //trueelectron_truemom_GENIE-> SetMaximum(100);
    trueelectron_truemom_GENIE-> Draw("hist");
    trueelectron_truemom_GENIE->GetXaxis()->SetTitle("p_{#e} [GeV/c]");
    trueelectron_truemom_GENIE->GetYaxis()->SetTitle("number of events");

    TLegend *l1 = new TLegend(0.5, 0.7, 0.9, 0.9);
    l1 -> AddEntry(trueelectron_truemom_CCQE_GENIE, "CCQE", "f");
    l1 -> AddEntry(trueelectron_truemom_CCMEC_GENIE, "CCMEC", "f");
    l1 -> AddEntry(trueelectron_truemom_CCRES_GENIE, "CCRES", "f");
    l1 -> AddEntry(trueelectron_truemom_CCCOH_GENIE, "CC-Coh", "f");
    l1 -> AddEntry(trueelectron_truemom_CCDIS_GENIE, "CCDIS", "f");
    l1 -> Draw();

    c1->Update();
    c1->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truemom_GENIErw.pdf");
    c1->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truemom_GENIErw.eps");
    c1->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truemom_GENIErw.png");
    c1->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truemom_GENIErw.C");

    TCanvas *c2 = new TCanvas("c2", "c2", 900, 900);

    trueelectron_truecostheta_CCQE_GENIE-> SetFillColor(kRed);
    trueelectron_truecostheta_CCMEC_GENIE-> SetFillColor(kGreen);
    trueelectron_truecostheta_CCRES_GENIE-> SetFillColor(kYellow);
    trueelectron_truecostheta_CCDIS_GENIE-> SetFillColor(kBlue);
    trueelectron_truecostheta_CCCOH_GENIE-> SetFillColor(kMagenta);

    THStack *trueelectron_truecostheta_GENIE = new THStack("trueelectron_truecostheta_GENIE","");
    trueelectron_truecostheta_GENIE-> Add(trueelectron_truecostheta_CCQE_GENIE);
    trueelectron_truecostheta_GENIE-> Add(trueelectron_truecostheta_CCMEC_GENIE);
    trueelectron_truecostheta_GENIE-> Add(trueelectron_truecostheta_CCRES_GENIE);
    trueelectron_truecostheta_GENIE-> Add(trueelectron_truecostheta_CCDIS_GENIE);
    trueelectron_truecostheta_GENIE-> Add(trueelectron_truecostheta_CCCOH_GENIE);
    //trueelectron_truemom_GENIE-> SetMaximum(100);
    trueelectron_truecostheta_GENIE-> Draw("hist");
    trueelectron_truecostheta_GENIE->GetXaxis()->SetTitle("cos #theta_{#e}");
    trueelectron_truecostheta_GENIE->GetYaxis()->SetTitle("number of events");

    TLegend *l2 = new TLegend(0.5, 0.7, 0.9, 0.9);
    l2 -> AddEntry(trueelectron_truecostheta_CCQE_GENIE, "CCQE", "f");
    l2 -> AddEntry(trueelectron_truecostheta_CCMEC_GENIE, "CCMEC", "f");
    l2 -> AddEntry(trueelectron_truecostheta_CCRES_GENIE, "CCRES", "f");
    l2 -> AddEntry(trueelectron_truecostheta_CCCOH_GENIE, "CC-Coh", "f");
    l2 -> AddEntry(trueelectron_truecostheta_CCDIS_GENIE, "CCDIS", "f");
    l2 -> Draw();

    c2->Update();
    c2->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truecostheta_GENIErw.pdf");
    c2->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truecostheta_GENIErw.eps");
    c2->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truecostheta_GENIErw.png");
    c2->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truecostheta_GENIErw.C");

    TCanvas *c3 = new TCanvas("c3", "c3", 900, 900);

    trueelectron_truephi_CCQE_GENIE-> SetFillColor(kRed);
    trueelectron_truephi_CCMEC_GENIE-> SetFillColor(kGreen);
    trueelectron_truephi_CCRES_GENIE-> SetFillColor(kYellow);
    trueelectron_truephi_CCDIS_GENIE-> SetFillColor(kBlue);
    trueelectron_truephi_CCCOH_GENIE-> SetFillColor(kMagenta);

    THStack *trueelectron_truephi_GENIE = new THStack("trueelectron_truephi_GENIE","");
    trueelectron_truephi_GENIE-> Add(trueelectron_truephi_CCQE_GENIE);
    trueelectron_truephi_GENIE-> Add(trueelectron_truephi_CCMEC_GENIE);
    trueelectron_truephi_GENIE-> Add(trueelectron_truephi_CCRES_GENIE);
    trueelectron_truephi_GENIE-> Add(trueelectron_truephi_CCDIS_GENIE);
    trueelectron_truephi_GENIE-> Add(trueelectron_truephi_CCCOH_GENIE);
    //trueelectron_truemom_GENIE-> SetMaximum(100);
    trueelectron_truephi_GENIE-> Draw("hist");
    trueelectron_truephi_GENIE->GetXaxis()->SetTitle("#phi_{#e}");
    trueelectron_truephi_GENIE->GetYaxis()->SetTitle("number of events");

    TLegend *l3 = new TLegend(0.5, 0.7, 0.9, 0.9);
    l3 -> AddEntry(trueelectron_truephi_CCQE_GENIE, "CCQE", "f");
    l3 -> AddEntry(trueelectron_truephi_CCMEC_GENIE, "CCMEC", "f");
    l3 -> AddEntry(trueelectron_truephi_CCRES_GENIE, "CCRES", "f");
    l3 -> AddEntry(trueelectron_truephi_CCCOH_GENIE, "CC-Coh", "f");
    l3 -> AddEntry(trueelectron_truephi_CCDIS_GENIE, "CCDIS", "f");
    l3 -> Draw();

    c3->Update();
    c3->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truephi_GENIErw.pdf");
    c3->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truephi_GENIErw.eps");
    c3->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truephi_GENIErw.png");
    c3->Print("/Users/castillofernr/Documents/SBN/GENIE/microboonetunning//output/plots/trueelectron_truephi_GENIErw.C");
