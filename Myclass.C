...
//********************************************************GENIE_REWEIGHTED***********************************************************************//
//**********************************************************************************************************************************************//  
 TFile* file_G = TFile::Open("a_lot.root"); 
...
//*******************************************************finding_bin_for_CCQE******************************************************************//
	 ...
	 if ((npospion + nnegpion + nnpion + nproton) ==0){
	   //EnuPan0_CCQE_GiBBUnorw->Fill(GetEuB(0, Esum, 1 , nproton),1);
	   EnuPan0_CCQE_GiBBUnorw->Fill(GetEuB(0, Esum, 1 , nproton),weight);
	   hprof_EnuPan0_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCQE_bin-1)[0]);
	 ...
	 if (((npospion + nnegpion + nnpion) ==0) && (nproton > 0)) {
	   ...
	   hprof_EnuPanN_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCQE_bin-1)[0]);
	 ...
	 if (((npospion + nnegpion + nnpion) ==0) && (nproton ==1)) {
	   ...
	   hprof_EnuDL_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCQE_bin-1)[0]);
...
//***************************************************finding_bin_for_CCRES******************************************************************//  
	 ...
	 if ((npospion + nnegpion + nnpion + nproton) ==0){
	   ...
	   hprof_EnuPan0_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCRES_bin-1)[2]);
	   hprof_EnuPan0_GiBBUnorw->Fill(lepIn_E,lepIn_E - GetEuB(0, Esum, 1 , nproton),weight);
	 }
	 ...
	 if (((npospion + nnegpion + nnpion) ==0) && nproton > 0) {
	   ...
	   hprof_EnuPanN_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCRES_bin-1)[2]);
	   hprof_EnuPanN_GiBBUnorw->Fill(lepIn_E,lepIn_E - GetEuB(0, Esum, 1 , nproton),weight);
	 }
	 ...
	 if (((npospion + nnegpion + nnpion) ==0) && nproton ==1) {
	   ...
	   hprof_EnuDL_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCRES_bin-1)[2]);
	   hprof_EnuDL_GiBBUnorw->Fill(lepIn_E,lepIn_E - GetEuB(0, Esum, 2 , nproton),weight);
	 }
...
//*******************************************************finding_bin_for_CCDIS******************************************************************//  
	...
	// EnuWC_CCDIS_GiBBU->Fill(GetEuB(Epion, Esum, 3 , nproton), 1);
	 ...
	 if ((npospion + nnegpion + nnpion + nproton) ==0){
	   ...
	   hprof_EnuPan0_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCDIS_bin-1)[3]);
	   hprof_EnuPan0_GiBBUnorw->Fill(lepIn_E,lepIn_E - GetEuB(0, Esum, 1 , nproton),weight);
	 }
	 ...
	 if (((npospion + nnegpion + nnpion) ==0) && nproton > 0) {
	   ...
	   hprof_EnuPanN_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCDIS_bin-1)[3]);
	   hprof_EnuPanN_GiBBUnorw->Fill(lepIn_E,lepIn_E - GetEuB(0, Esum, 1 , nproton),weight);
	 }
	 ...
	 if (((npospion + nnegpion + nnpion) ==0) && nproton ==1) {
	   ...
	   hprof_EnuDL_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCDIS_bin-1)[3]);
	   hprof_EnuDL_GiBBUnorw->Fill(lepIn_E,lepIn_E - GetEuB(0, Esum, 2 , nproton),weight);
	 } 
      }
      /*else if (evType==33)
...
//*******************************************************finding_bin_for_CCMEC******************************************************************//  
	 ...
	 if ((npospion + nnegpion + nnpion + nproton) ==0){
	   ...
	   hprof_EnuPan0_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCMEC_bin-1)[1]);
	   hprof_EnuPan0_GiBBUnorw->Fill(lepIn_E,lepIn_E - GetEuB(0, Esum, 1 , nproton),weight);
	 }
	 ...
	 //std::cout<<" Is there any PanN data "<<std::endl;
	   ...
	   hprof_EnuPanN_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCMEC_bin-1)[1]);
	   hprof_EnuPanN_GiBBUnorw->Fill(lepIn_E,lepIn_E - GetEuB(0, Esum, 1 , nproton),weight);
	 }
	 ...
	 //std::cout<<" Is there any EnuDL data "<<std::endl;
	   ...
	   hprof_EnuDL_GiBBU->Fill(lepIn_E,lepIn_E - GetEuB(Epion, Esum, 3 , nproton),weight*TMatrixDRow(*m,CCMEC_bin-1)[1]);
	   hprof_EnuDL_GiBBUnorw->Fill(lepIn_E,lepIn_E - GetEuB(0, Esum, 2 , nproton),weight);
	 }
      }
      /*else if (evType==36)
...
//***************************************************************CCRES***********************************************************************//	
	if (TrueEnu_CCRES_GiBBU->GetBinContent(i+1)==0)
	{
	 Rewighting_Gibbu_Genie_norw[i][2]=TrueEnu_CCRES_GENIEnorw->GetBinContent(i+1);
		...
		{
	 	 Rewighting_Gibbu_Genie_norw[i][2]=TrueEnu_CCRES_GENIEnorw->GetBinContent(i+1)/TrueEnu_CCRES_GiBBU->GetBinContent(i+1);
		}
//********************************************************CCQE***********************************************************************//		
	if (TrueEnu_CCDIS_GiBBU->GetBinContent(i+1)==0)
	{
...
std::cout<<" CCQE: "<<Rewighting_Gibbu_Genie_norw[i][0]<<" CCMEC: "<<Rewighting_Gibbu_Genie_norw[i][1]<<" CCRES: "<<Rewighting_Gibbu_Genie_norw[i][2]<<" CCDIS: "<<Rewighting_Gibbu_Genie_norw[i][3]<<" CCCOH: "<<Rewighting_Gibbu_Genie_norw[i][4]<<std::endl;

}
//***********************************************************************************************************************************************//
//******************************************Reweighting_GiBBU_to_GENIE********************************************//
//***********************************************************************************************************************************************//
std::cout<<" ok. what's going on "<<TrueEnu_CCRES_GiBBU->GetBinContent(3)<<std::endl;
for (int l=0;l<60;l++)
	{
					//CCQE//
	EnuWC_CCQE_GiBBU->SetBinContent(l+1,(EnuWC_CCQE_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][0]);
	EnuPan0_CCQE_GiBBU->SetBinContent(l+1,(EnuPan0_CCQE_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][0]);
	EnuPanN_CCQE_GiBBU->SetBinContent(l+1,(EnuPanN_CCQE_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][0]);
	EnuDL_CCQE_GiBBU->SetBinContent(l+1,(EnuDL_CCQE_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][0]);
	
					//CCMEC//
	EnuWC_CCMEC_GiBBU->SetBinContent(l+1,(EnuWC_CCMEC_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][1]);
	EnuPan0_CCMEC_GiBBU->SetBinContent(l+1,(EnuPan0_CCMEC_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][1]);
	EnuPanN_CCMEC_GiBBU->SetBinContent(l+1,(EnuPanN_CCMEC_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][1]);
	EnuDL_CCMEC_GiBBU->SetBinContent(l+1,(EnuDL_CCMEC_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][1]);
	
					//CCRES//				
	EnuWC_CCRES_GiBBU->SetBinContent(l+1,(EnuWC_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][2]);
	EnuPan0_CCRES_GiBBU->SetBinContent(l+1,(EnuPan0_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][2]);
	EnuPanN_CCRES_GiBBU->SetBinContent(l+1,(EnuPanN_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][2]);
	EnuDL_CCRES_GiBBU->SetBinContent(l+1,(EnuDL_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][2]);
	
					//CCDIS//
	EnuWC_CCDIS_GiBBU->SetBinContent(l+1,(EnuWC_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][3]);
	EnuPan0_CCDIS_GiBBU->SetBinContent(l+1,(EnuPan0_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][3]);
	EnuPanN_CCDIS_GiBBU->SetBinContent(l+1,(EnuPanN_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][3]);
	EnuDL_CCDIS_GiBBU->SetBinContent(l+1,(EnuDL_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][3]);
	
					//CCCOH//
	EnuWC_CCCOH_GiBBU->SetBinContent(l+1,(EnuWC_CCCOH_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][4]);
	EnuPan0_CCCOH_GiBBU->SetBinContent(l+1,(EnuPan0_CCCOH_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][4]);
	EnuPanN_CCCOH_GiBBU->SetBinContent(l+1,(EnuPanN_CCCOH_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][4]);
	EnuDL_CCCOH_GiBBU->SetBinContent(l+1,(EnuDL_CCCOH_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][4]);
	
	/*hprof_EnuWC_GiBBU->SetBinContent(l+1,(hprof_EnuWC_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu[l][4]);
	hprof_EnuPan0_GiBBU
	hprof_EnuPanN_GiBBU
	hprof_EnuDl_GiBBU*/
...
///////////
  ...
  l11->AddEntry(CCQE,"","f");
  l11->AddEntry(Cresonant,"","f");
  l11->AddEntry(pi_plus_plus_n_bkg,"","f");
  l11->AddEntry(pi_zero_plus_p_bkg,"","f");
  l11->AddEntry(CCDIS,"","f");
  l11->AddEntry(CCQE_two_p_two_h,"","f");
  l11->AddEntry(Delta_two_p_two_h,"","f");
  l11->AddEntry(two_pion_bkg,"","f");
...
//............................................................................................................................................//
//............................................................................................................................................//
TFile Mite("a__whole_lot.root", "RECREATE");
bin_1->Write();
bin_2->Write();
bin_3->Write();
bin_4->Write();
...
Mite.WriteObject(&Reconstructed_bins,"Reconstructed_bins");
