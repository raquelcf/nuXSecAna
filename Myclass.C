...
//************************************************Some_Histograms_For_Analysis******************************************************************//
TH1D *Mean_EnuWC_1=new TH1D("Mean_EnuWC_1", "Mean_EnuWC_1", 60, 0, 3);
TH1D *Mean_EnuWC_2=new TH1D("Mean_EnuWC_2", "Mean_EnuWC_2", 60, 0, 3);
TH1D *Mean_EnuWC_3=new TH1D("Mean_EnuWC_3", "Mean_EnuWC_3", 60, 0, 3);
TH1D *Mean_EnuWC_4=new TH1D("Mean_EnuWC_4", "Mean_EnuWC_4", 60, 0, 3);
TH1D *Mean_EnuWC_5=new TH1D("Mean_EnuWC_5", "Mean_EnuWC_5", 60, 0, 3);
TH1D *Mean_EnuWC_6=new TH1D("Mean_EnuWC_6", "Mean_EnuWC_6", 60, 0, 3);
TH1D *Mean_EnuWC_7=new TH1D("Mean_EnuWC_7", "Mean_EnuWC_7", 60, 0, 3);
TH1D *Mean_EnuWC_8=new TH1D("Mean_EnuWC_8", "Mean_EnuWC_8", 60, 0, 3);
TH1D *Mean_EnuWC_9=new TH1D("Mean_EnuWC_9", "Mean_EnuWC_9", 60, 0, 3);
TH1D *Mean_EnuWC_10=new TH1D("Mean_EnuWC_10", "Mean_EnuWC_10", 60, 0, 3);
TH1D *Mean_EnuWC_11=new TH1D("Mean_EnuWC_11", "Mean_EnuWC_11", 60, 0, 3);
TH1D *Mean_EnuWC_12=new TH1D("Mean_EnuWC_12", "Mean_EnuWC_12", 60, 0, 3);
TH1D *Mean_EnuWC_13=new TH1D("Mean_EnuWC_13", "Mean_EnuWC_13", 60, 0, 3);

TH1D *Mean_EnuPanN_1=new TH1D("Mean_EnuPanN_1", "Mean_EnuPanN_1", 60, 0, 3);
TH1D *Mean_EnuPanN_2=new TH1D("Mean_EnuPanN_2", "Mean_EnuPanN_2", 60, 0, 3);
TH1D *Mean_EnuPanN_3=new TH1D("Mean_EnuPanN_3", "Mean_EnuPanN_3", 60, 0, 3);
TH1D *Mean_EnuPanN_4=new TH1D("Mean_EnuPanN_4", "Mean_EnuPanN_4", 60, 0, 3);
TH1D *Mean_EnuPanN_5=new TH1D("Mean_EnuPanN_5", "Mean_EnuPanN_5", 60, 0, 3);
TH1D *Mean_EnuPanN_6=new TH1D("Mean_EnuPanN_6", "Mean_EnuPanN_6", 60, 0, 3);
TH1D *Mean_EnuPanN_7=new TH1D("Mean_EnuPanN_7", "Mean_EnuPanN_7", 60, 0, 3);
TH1D *Mean_EnuPanN_8=new TH1D("Mean_EnuPanN_8", "Mean_EnuPanN_8", 60, 0, 3);
TH1D *Mean_EnuPanN_9=new TH1D("Mean_EnuPanN_9", "Mean_EnuPanN_9", 60, 0, 3);
TH1D *Mean_EnuPanN_10=new TH1D("Mean_EnuPanN_10", "Mean_EnuPanN_10", 60, 0, 3);
TH1D *Mean_EnuPanN_11=new TH1D("Mean_EnuPanN_11", "Mean_EnuPanN_11", 60, 0, 3);
TH1D *Mean_EnuPanN_12=new TH1D("Mean_EnuPanN_12", "Mean_EnuPanN_12", 60, 0, 3);
TH1D *Mean_EnuPanN_13=new TH1D("Mean_EnuPanN_13", "Mean_EnuPanN_13", 60, 0, 3);

TH1D *Mean_EnuPan0_1=new TH1D("Mean_EnuPan0_1", "Mean_EnuPan0_1", 60, 0, 3);
TH1D *Mean_EnuPan0_2=new TH1D("Mean_EnuPan0_2", "Mean_EnuPan0_2", 60, 0, 3);
TH1D *Mean_EnuPan0_3=new TH1D("Mean_EnuPan0_3", "Mean_EnuPan0_3", 60, 0, 3);
TH1D *Mean_EnuPan0_4=new TH1D("Mean_EnuPan0_4", "Mean_EnuPan0_4", 60, 0, 3);
TH1D *Mean_EnuPan0_5=new TH1D("Mean_EnuPan0_5", "Mean_EnuPan0_5", 60, 0, 3);
TH1D *Mean_EnuPan0_6=new TH1D("Mean_EnuPan0_6", "Mean_EnuPan0_6", 60, 0, 3);
TH1D *Mean_EnuPan0_7=new TH1D("Mean_EnuPan0_7", "Mean_EnuPan0_7", 60, 0, 3);
TH1D *Mean_EnuPan0_8=new TH1D("Mean_EnuPan0_8", "Mean_EnuPan0_8", 60, 0, 3);
TH1D *Mean_EnuPan0_9=new TH1D("Mean_EnuPan0_9", "Mean_EnuPan0_9", 60, 0, 3);
TH1D *Mean_EnuPan0_10=new TH1D("Mean_EnuPan0_10", "Mean_EnuPan0_10", 60, 0, 3);
TH1D *Mean_EnuPan0_11=new TH1D("Mean_EnuPan0_11", "Mean_EnuPan0_11", 60, 0, 3);
TH1D *Mean_EnuPan0_12=new TH1D("Mean_EnuPan0_12", "Mean_EnuPan0_12", 60, 0, 3);
TH1D *Mean_EnuPan0_13=new TH1D("Mean_EnuPan0_13", "Mean_EnuPan0_13", 60, 0, 3);

TH1D *Mean_EnuDL_1=new TH1D("Mean_EnuDL_1", "Mean_EnuDL_1", 60, 0, 3);
TH1D *Mean_EnuDL_2=new TH1D("Mean_EnuDL_2", "Mean_EnuDL_2", 60, 0, 3);
TH1D *Mean_EnuDL_3=new TH1D("Mean_EnuDL_3", "Mean_EnuDL_3", 60, 0, 3);
TH1D *Mean_EnuDL_4=new TH1D("Mean_EnuDL_4", "Mean_EnuDL_4", 60, 0, 3);
TH1D *Mean_EnuDL_5=new TH1D("Mean_EnuDL_5", "Mean_EnuDL_5", 60, 0, 3);
TH1D *Mean_EnuDL_6=new TH1D("Mean_EnuDL_6", "Mean_EnuDL_6", 60, 0, 3);
TH1D *Mean_EnuDL_7=new TH1D("Mean_EnuDL_7", "Mean_EnuDL_7", 60, 0, 3);
TH1D *Mean_EnuDL_8=new TH1D("Mean_EnuDL_8", "Mean_EnuDL_8", 60, 0, 3);
TH1D *Mean_EnuDL_9=new TH1D("Mean_EnuDL_9", "Mean_EnuDL_9", 60, 0, 3);
TH1D *Mean_EnuDL_10=new TH1D("Mean_EnuDL_10", "Mean_EnuDL_10", 60, 0, 3);
TH1D *Mean_EnuDL_11=new TH1D("Mean_EnuDL_11", "Mean_EnuDL_11", 60, 0, 3);
TH1D *Mean_EnuDL_12=new TH1D("Mean_EnuDL_12", "Mean_EnuDL_12", 60, 0, 3);
TH1D *Mean_EnuDL_13=new TH1D("Mean_EnuDL_13", "Mean_EnuDL_13", 60, 0, 3);

						//norw//					
TH1D *Mean_EnuWC_norw_1=new TH1D("Mean_EnuWC_norw_1", "Mean_EnuWC_norw_1", 60, 0, 3);
TH1D *Mean_EnuWC_norw_2=new TH1D("Mean_EnuWC_norw_2", "Mean_EnuWC_norw_2", 60, 0, 3);
TH1D *Mean_EnuWC_norw_3=new TH1D("Mean_EnuWC_norw_3", "Mean_EnuWC_norw_3", 60, 0, 3);
TH1D *Mean_EnuWC_norw_4=new TH1D("Mean_EnuWC_norw_4", "Mean_EnuWC_norw_4", 60, 0, 3);
TH1D *Mean_EnuWC_norw_5=new TH1D("Mean_EnuWC_norw_5", "Mean_EnuWC_norw_5", 60, 0, 3);
TH1D *Mean_EnuWC_norw_6=new TH1D("Mean_EnuWC_norw_6", "Mean_EnuWC_norw_6", 60, 0, 3);
TH1D *Mean_EnuWC_norw_7=new TH1D("Mean_EnuWC_norw_7", "Mean_EnuWC_norw_7", 60, 0, 3);
TH1D *Mean_EnuWC_norw_8=new TH1D("Mean_EnuWC_norw_8", "Mean_EnuWC_norw_8", 60, 0, 3);
TH1D *Mean_EnuWC_norw_9=new TH1D("Mean_EnuWC_norw_9", "Mean_EnuWC_norw_9", 60, 0, 3);
TH1D *Mean_EnuWC_norw_10=new TH1D("Mean_EnuWC_norw_10", "Mean_EnuWC_norw_10", 60, 0, 3);
TH1D *Mean_EnuWC_norw_11=new TH1D("Mean_EnuWC_norw_11", "Mean_EnuWC_norw_11", 60, 0, 3);
TH1D *Mean_EnuWC_norw_12=new TH1D("Mean_EnuWC_norw_12", "Mean_EnuWC_norw_12", 60, 0, 3);
TH1D *Mean_EnuWC_norw_13=new TH1D("Mean_EnuWC_norw_13", "Mean_EnuWC_norw_13", 60, 0, 3);

TH1D *Mean_EnuPanN_norw_1=new TH1D("Mean_EnuPanN_norw_1", "Mean_EnuPanN_norw_1", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_2=new TH1D("Mean_EnuPanN_norw_2", "Mean_EnuPanN_norw_2", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_3=new TH1D("Mean_EnuPanN_norw_3", "Mean_EnuPanN_norw_3", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_4=new TH1D("Mean_EnuPanN_norw_4", "Mean_EnuPanN_norw_4", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_5=new TH1D("Mean_EnuPanN_norw_5", "Mean_EnuPanN_norw_5", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_6=new TH1D("Mean_EnuPanN_norw_6", "Mean_EnuPanN_norw_6", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_7=new TH1D("Mean_EnuPanN_norw_7", "Mean_EnuPanN_norw_7", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_8=new TH1D("Mean_EnuPanN_norw_8", "Mean_EnuPanN_norw_8", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_9=new TH1D("Mean_EnuPanN_norw_9", "Mean_EnuPanN_norw_9", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_10=new TH1D("Mean_EnuPanN_norw_10", "Mean_EnuPanN_norw_10", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_11=new TH1D("Mean_EnuPanN_norw_11", "Mean_EnuPanN_norw_11", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_12=new TH1D("Mean_EnuPanN_norw_12", "Mean_EnuPanN_norw_12", 60, 0, 3);
TH1D *Mean_EnuPanN_norw_13=new TH1D("Mean_EnuPanN_norw_13", "Mean_EnuPanN_norw_13", 60, 0, 3);

TH1D *Mean_EnuPan0_norw_1=new TH1D("Mean_EnuPan0_norw_1", "Mean_EnuPan0_norw_1", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_2=new TH1D("Mean_EnuPan0_norw_2", "Mean_EnuPan0_norw_2", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_3=new TH1D("Mean_EnuPan0_norw_3", "Mean_EnuPan0_norw_3", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_4=new TH1D("Mean_EnuPan0_norw_4", "Mean_EnuPan0_norw_4", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_5=new TH1D("Mean_EnuPan0_norw_5", "Mean_EnuPan0_norw_5", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_6=new TH1D("Mean_EnuPan0_norw_6", "Mean_EnuPan0_norw_6", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_7=new TH1D("Mean_EnuPan0_norw_7", "Mean_EnuPan0_norw_7", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_8=new TH1D("Mean_EnuPan0_norw_8", "Mean_EnuPan0_norw_8", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_9=new TH1D("Mean_EnuPan0_norw_9", "Mean_EnuPan0_norw_9", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_10=new TH1D("Mean_EnuPan0_norw_10", "Mean_EnuPan0_norw_10", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_11=new TH1D("Mean_EnuPan0_norw_11", "Mean_EnuPan0_norw_11", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_12=new TH1D("Mean_EnuPan0_norw_12", "Mean_EnuPan0_norw_12", 60, 0, 3);
TH1D *Mean_EnuPan0_norw_13=new TH1D("Mean_EnuPan0_norw_13", "Mean_EnuPan0_norw_13", 60, 0, 3);

TH1D *Mean_EnuDL_norw_1=new TH1D("Mean_EnuDL_norw_1", "Mean_EnuDL_norw_1", 60, 0, 3);
TH1D *Mean_EnuDL_norw_2=new TH1D("Mean_EnuDL_norw_2", "Mean_EnuDL_norw_2", 60, 0, 3);
TH1D *Mean_EnuDL_norw_3=new TH1D("Mean_EnuDL_norw_3", "Mean_EnuDL_norw_3", 60, 0, 3);
TH1D *Mean_EnuDL_norw_4=new TH1D("Mean_EnuDL_norw_4", "Mean_EnuDL_norw_4", 60, 0, 3);
TH1D *Mean_EnuDL_norw_5=new TH1D("Mean_EnuDL_norw_5", "Mean_EnuDL_norw_5", 60, 0, 3);
TH1D *Mean_EnuDL_norw_6=new TH1D("Mean_EnuDL_norw_6", "Mean_EnuDL_norw_6", 60, 0, 3);
TH1D *Mean_EnuDL_norw_7=new TH1D("Mean_EnuDL_norw_7", "Mean_EnuDL_norw_7", 60, 0, 3);
TH1D *Mean_EnuDL_norw_8=new TH1D("Mean_EnuDL_norw_8", "Mean_EnuDL_norw_8", 60, 0, 3);
TH1D *Mean_EnuDL_norw_9=new TH1D("Mean_EnuDL_norw_9", "Mean_EnuDL_norw_9", 60, 0, 3);
TH1D *Mean_EnuDL_norw_10=new TH1D("Mean_EnuDL_norw_10", "Mean_EnuDL_norw_10", 60, 0, 3);
TH1D *Mean_EnuDL_norw_11=new TH1D("Mean_EnuDL_norw_11", "Mean_EnuDL_norw_11", 60, 0, 3);
TH1D *Mean_EnuDL_norw_12=new TH1D("Mean_EnuDL_norw_12", "Mean_EnuDL_norw_12", 60, 0, 3);
TH1D *Mean_EnuDL_norw_13=new TH1D("Mean_EnuDL_norw_13", "Mean_EnuDL_norw_13", 60, 0, 3);

TH1D *Mean_True_1=new TH1D("Mean_True_1", "Mean_True_1", 60, 0, 3);
TH1D *Mean_True_2=new TH1D("Mean_True_2", "Mean_True_2", 60, 0, 3);
TH1D *Mean_True_3=new TH1D("Mean_True_3", "Mean_True_3", 60, 0, 3);
TH1D *Mean_True_4=new TH1D("Mean_True_4", "Mean_True_4", 60, 0, 3);
TH1D *Mean_True_5=new TH1D("Mean_True_5", "Mean_True_5", 60, 0, 3);
TH1D *Mean_True_6=new TH1D("Mean_True_6", "Mean_True_6", 60, 0, 3);
TH1D *Mean_True_7=new TH1D("Mean_True_7", "Mean_True_7", 60, 0, 3);
TH1D *Mean_True_8=new TH1D("Mean_True_8", "Mean_True_8", 60, 0, 3);
TH1D *Mean_True_9=new TH1D("Mean_True_9", "Mean_True_9", 60, 0, 3);
TH1D *Mean_True_10=new TH1D("Mean_True_10", "Mean_True_10", 60, 0, 3);
TH1D *Mean_True_11=new TH1D("Mean_True_11", "Mean_True_11", 60, 0, 3);
TH1D *Mean_True_12=new TH1D("Mean_True_12", "Mean_True_12", 60, 0, 3);
TH1D *Mean_True_13=new TH1D("Mean_True_13", "Mean_True_13", 60, 0, 3);
...
void calculate_histograms(double Energy_Ve, int bool_EnuPanN, int bool_EnuPan0, int bool_EnuDL,double E_EnuWC,double E_EnuPanN,double E_EnuPan0,double E_EnuDL,double w_i,double rw_i)
{
//*****************************A_substitute_approach_for_the_Tprofile_plots***********************************************************//     
   if ((Energy_Ve>=0.1)&&(Energy_Ve<0.2))
   {
    Mean_EnuWC_1->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_1->Fill(E_EnuPanN,w_i*rw_i); 
    if (bool_EnuPan0==1) Mean_EnuPan0_1->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_1->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_1->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_1->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_1->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_1->Fill(E_EnuDL,w_i);
    Mean_True_1->Fill(Energy_Ve,w_i);
   }
   if ((Energy_Ve>=0.2)&&(Energy_Ve<0.3))
   {
    Mean_EnuWC_2->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_2->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_2->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_2->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_2->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_2->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_2->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_2->Fill(E_EnuDL,w_i);
    Mean_True_2->Fill(Energy_Ve,w_i);
   }
   if ((Energy_Ve>=0.3)&&(Energy_Ve<0.4))
   {
    Mean_EnuWC_3->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_3->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_3->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_3->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_3->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_3->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_3->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_3->Fill(E_EnuDL,w_i);
    Mean_True_3->Fill(Energy_Ve,w_i);
    
    }
   if ((Energy_Ve>=0.4)&&(Energy_Ve<0.5))
   {
    Mean_EnuWC_4->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_4->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_4->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_4->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_4->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_4->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_4->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_4->Fill(E_EnuDL,w_i);
    Mean_True_4->Fill(Energy_Ve,w_i);
   }
   if ((Energy_Ve>=0.5)&&(Energy_Ve<0.6))
   {
    Mean_EnuWC_5->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_5->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_5->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_5->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_5->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_5->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_5->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_5->Fill(E_EnuDL,w_i);
    Mean_True_5->Fill(Energy_Ve,w_i);
    }
   if ((Energy_Ve>=0.6)&&(Energy_Ve<0.7))
   {
    Mean_EnuWC_6->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_6->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_6->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_6->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_6->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_6->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_6->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_6->Fill(E_EnuDL,w_i);
    Mean_True_6->Fill(Energy_Ve,w_i);
   }
   if ((Energy_Ve>=0.7)&&(Energy_Ve<0.8))
   {
    Mean_EnuWC_7->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_7->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_7->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_7->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_7->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_7->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_7->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_7->Fill(E_EnuDL,w_i); 
    Mean_True_7->Fill(Energy_Ve,w_i);  
   } 
   if ((Energy_Ve>=0.8)&&(Energy_Ve<0.9))
   {
    Mean_EnuWC_8->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_8->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_8->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_8->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_8->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_8->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_8->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_8->Fill(E_EnuDL,w_i);
    Mean_True_8->Fill(Energy_Ve,w_i);
    }
   if ((Energy_Ve>=0.9)&&(Energy_Ve<1.0))
   {
   Mean_EnuWC_9->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_9->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_9->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_9->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_9->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_9->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_9->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_9->Fill(E_EnuDL,w_i);
    Mean_True_9->Fill(Energy_Ve,w_i);
   }
   if ((Energy_Ve>=1.0)&&(Energy_Ve<1.1))
   {
    Mean_EnuWC_10->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_10->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_10->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_10->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_10->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_10->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_10->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_10->Fill(E_EnuDL,w_i);
    Mean_True_10->Fill(Energy_Ve,w_i);
   }
   if ((Energy_Ve>=1.1)&&(Energy_Ve<1.2))
   {
   Mean_EnuWC_11->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_11->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_11->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_11->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_11->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_11->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_11->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_11->Fill(E_EnuDL,w_i);
    Mean_True_11->Fill(Energy_Ve,w_i);
   }
   if ((Energy_Ve>=1.2)&&(Energy_Ve<1.3))
   {
    Mean_EnuWC_12->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_12->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_12->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_12->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_12->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_12->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_12->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_12->Fill(E_EnuDL,w_i);
    Mean_True_12->Fill(Energy_Ve,w_i);
   }
   if ((Energy_Ve>=1.3)&&(Energy_Ve<1.4))
   {
    Mean_EnuWC_13->Fill(E_EnuWC,w_i*rw_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_13->Fill(E_EnuPanN,w_i*rw_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_13->Fill(E_EnuPan0,w_i*rw_i);
    if (bool_EnuDL==1) Mean_EnuDL_13->Fill(E_EnuDL,w_i*rw_i);
    
    Mean_EnuWC_norw_13->Fill(E_EnuWC,w_i);
    if (bool_EnuPanN==1) Mean_EnuPanN_norw_13->Fill(E_EnuPanN,w_i);
    if (bool_EnuPan0==1) Mean_EnuPan0_norw_13->Fill(E_EnuPan0,w_i);
    if (bool_EnuDL==1) Mean_EnuDL_norw_13->Fill(E_EnuDL,w_i);
    Mean_True_13->Fill(Energy_Ve,w_i);
   }
...
//*****************************************************************************************************************************************//     
      calculate_histograms,(lepIn_E, test.Is_EnuPanN, test.Is_EnuPan0, test.Is_EnuDL,test.Reco_EnuWC,test.Reco_EnuPanN,test.Reco_EnuPan0,test.Reco_EnuDL,weight,TMatrixDRow(*m,CCQE_bin-1)[0]);	
...
//*****************************Filling_the_vectors_by_calling_the_function********************************************************************//
//*****************************************************************************************************************************************//     
      calculate_histograms(lepIn_E, test.Is_EnuPanN, test.Is_EnuPan0, test.Is_EnuDL,test.Reco_EnuWC,test.Reco_EnuPanN,test.Reco_EnuPan0,test.Reco_EnuDL,weight,TMatrixDRow(*m,CCRES_bin-1)[2]);	
...
//*****************************Filling_the_vectors_by_calling_the_function********************************************************************//
//*****************************************************************************************************************************************//     
      calculate_histograms(lepIn_E, test.Is_EnuPanN, test.Is_EnuPan0, test.Is_EnuDL,test.Reco_EnuWC,test.Reco_EnuPanN,test.Reco_EnuPan0,test.Reco_EnuDL,weight,TMatrixDRow(*m,CCDIS_bin-1)[3]);	
...
//*****************************Filling_the_vectors_by_calling_the_function********************************************************************//
//*****************************************************************************************************************************************//     
      calculate_histograms(lepIn_E, test.Is_EnuPanN, test.Is_EnuPan0, test.Is_EnuDL,test.Reco_EnuWC,test.Reco_EnuPanN,test.Reco_EnuPan0,test.Reco_EnuDL,weight,TMatrixDRow(*m,CCMEC_bin-1)[1]);	
...
Mean_EnuWC.at(0)=Mean_EnuWC_1->GetMean();
Mean_EnuWC.at(1)=Mean_EnuWC_2->GetMean();
Mean_EnuWC.at(2)=Mean_EnuWC_3->GetMean();
Mean_EnuWC.at(3)=Mean_EnuWC_4->GetMean();
Mean_EnuWC.at(4)=Mean_EnuWC_5->GetMean();
Mean_EnuWC.at(5)=Mean_EnuWC_6->GetMean();
Mean_EnuWC.at(6)=Mean_EnuWC_7->GetMean();
Mean_EnuWC.at(7)=Mean_EnuWC_8->GetMean();
Mean_EnuWC.at(8)=Mean_EnuWC_9->GetMean();
Mean_EnuWC.at(9)=Mean_EnuWC_10->GetMean();
Mean_EnuWC.at(10)=Mean_EnuWC_11->GetMean();
Mean_EnuWC.at(11)=Mean_EnuWC_12->GetMean();
Mean_EnuWC.at(12)=Mean_EnuWC_13->GetMean();

Mean_EnuPanN.at(0)=Mean_EnuPanN_1->GetMean();
Mean_EnuPanN.at(1)=Mean_EnuPanN_2->GetMean();
Mean_EnuPanN.at(2)=Mean_EnuPanN_3->GetMean();
Mean_EnuPanN.at(3)=Mean_EnuPanN_4->GetMean();
Mean_EnuPanN.at(4)=Mean_EnuPanN_5->GetMean();
Mean_EnuPanN.at(5)=Mean_EnuPanN_6->GetMean();
Mean_EnuPanN.at(6)=Mean_EnuPanN_7->GetMean();
Mean_EnuPanN.at(7)=Mean_EnuPanN_8->GetMean();
Mean_EnuPanN.at(8)=Mean_EnuPanN_9->GetMean();
Mean_EnuPanN.at(9)=Mean_EnuPanN_10->GetMean();
Mean_EnuPanN.at(10)=Mean_EnuPanN_11->GetMean();
Mean_EnuPanN.at(11)=Mean_EnuPanN_12->GetMean();
Mean_EnuPanN.at(12)=Mean_EnuPanN_13->GetMean();

Mean_EnuPan0.at(0)=Mean_EnuPan0_1->GetMean();
Mean_EnuPan0.at(1)=Mean_EnuPan0_2->GetMean();
Mean_EnuPan0.at(2)=Mean_EnuPan0_3->GetMean();
Mean_EnuPan0.at(3)=Mean_EnuPan0_4->GetMean();
Mean_EnuPan0.at(4)=Mean_EnuPan0_5->GetMean();
Mean_EnuPan0.at(5)=Mean_EnuPan0_6->GetMean();
Mean_EnuPan0.at(6)=Mean_EnuPan0_7->GetMean();
Mean_EnuPan0.at(7)=Mean_EnuPan0_8->GetMean();
Mean_EnuPan0.at(8)=Mean_EnuPan0_9->GetMean();
Mean_EnuPan0.at(9)=Mean_EnuPan0_10->GetMean();
Mean_EnuPan0.at(10)=Mean_EnuPan0_11->GetMean();
Mean_EnuPan0.at(11)=Mean_EnuPan0_12->GetMean();
Mean_EnuPan0.at(12)=Mean_EnuPan0_13->GetMean();

Mean_EnuDL.at(0)=Mean_EnuDL_1->GetMean();
Mean_EnuDL.at(1)=Mean_EnuDL_2->GetMean();
Mean_EnuDL.at(2)=Mean_EnuDL_3->GetMean();
Mean_EnuDL.at(3)=Mean_EnuDL_4->GetMean();
Mean_EnuDL.at(4)=Mean_EnuDL_5->GetMean();
Mean_EnuDL.at(5)=Mean_EnuDL_6->GetMean();
Mean_EnuDL.at(6)=Mean_EnuDL_7->GetMean();
Mean_EnuDL.at(7)=Mean_EnuDL_8->GetMean();
Mean_EnuDL.at(8)=Mean_EnuDL_9->GetMean();
Mean_EnuDL.at(9)=Mean_EnuDL_10->GetMean();
Mean_EnuDL.at(10)=Mean_EnuDL_11->GetMean();
Mean_EnuDL.at(11)=Mean_EnuDL_12->GetMean();
Mean_EnuDL.at(12)=Mean_EnuDL_13->GetMean();

Mean_True.at(0)=Mean_True_1->GetMean();
Mean_True.at(1)=Mean_True_2->GetMean();
Mean_True.at(2)=Mean_True_3->GetMean();
Mean_True.at(3)=Mean_True_4->GetMean();
Mean_True.at(4)=Mean_True_5->GetMean();
Mean_True.at(5)=Mean_True_6->GetMean();
Mean_True.at(6)=Mean_True_7->GetMean();
Mean_True.at(7)=Mean_True_8->GetMean();
Mean_True.at(8)=Mean_True_9->GetMean();
Mean_True.at(9)=Mean_True_10->GetMean();
Mean_True.at(10)=Mean_True_11->GetMean();
Mean_True.at(11)=Mean_True_12->GetMean();
Mean_True.at(12)=Mean_True_13->GetMean();

							//norw//
Mean_EnuWC_norw.at(0)=Mean_EnuWC_norw_1->GetMean();
Mean_EnuWC_norw.at(1)=Mean_EnuWC_norw_2->GetMean();
Mean_EnuWC_norw.at(2)=Mean_EnuWC_norw_3->GetMean();
Mean_EnuWC_norw.at(3)=Mean_EnuWC_norw_4->GetMean();
Mean_EnuWC_norw.at(4)=Mean_EnuWC_norw_5->GetMean();
Mean_EnuWC_norw.at(5)=Mean_EnuWC_norw_6->GetMean();
Mean_EnuWC_norw.at(6)=Mean_EnuWC_norw_7->GetMean();
Mean_EnuWC_norw.at(7)=Mean_EnuWC_norw_8->GetMean();
Mean_EnuWC_norw.at(8)=Mean_EnuWC_norw_9->GetMean();
Mean_EnuWC_norw.at(9)=Mean_EnuWC_norw_10->GetMean();
Mean_EnuWC_norw.at(10)=Mean_EnuWC_norw_11->GetMean();
Mean_EnuWC_norw.at(11)=Mean_EnuWC_norw_12->GetMean();
Mean_EnuWC_norw.at(12)=Mean_EnuWC_norw_13->GetMean();

Mean_EnuPanN_norw.at(0)=Mean_EnuPanN_norw_1->GetMean();
Mean_EnuPanN_norw.at(1)=Mean_EnuPanN_norw_2->GetMean();
Mean_EnuPanN_norw.at(2)=Mean_EnuPanN_norw_3->GetMean();
Mean_EnuPanN_norw.at(3)=Mean_EnuPanN_norw_4->GetMean();
Mean_EnuPanN_norw.at(4)=Mean_EnuPanN_norw_5->GetMean();
Mean_EnuPanN_norw.at(5)=Mean_EnuPanN_norw_6->GetMean();
Mean_EnuPanN_norw.at(6)=Mean_EnuPanN_norw_7->GetMean();
Mean_EnuPanN_norw.at(7)=Mean_EnuPanN_norw_8->GetMean();
Mean_EnuPanN_norw.at(8)=Mean_EnuPanN_norw_9->GetMean();
Mean_EnuPanN_norw.at(9)=Mean_EnuPanN_norw_10->GetMean();
Mean_EnuPanN_norw.at(10)=Mean_EnuPanN_norw_11->GetMean();
Mean_EnuPanN_norw.at(11)=Mean_EnuPanN_norw_12->GetMean();
Mean_EnuPanN_norw.at(12)=Mean_EnuPanN_norw_13->GetMean();

Mean_EnuPan0_norw.at(0)=Mean_EnuPan0_norw_1->GetMean();
Mean_EnuPan0_norw.at(1)=Mean_EnuPan0_norw_2->GetMean();
Mean_EnuPan0_norw.at(2)=Mean_EnuPan0_norw_3->GetMean();
Mean_EnuPan0_norw.at(3)=Mean_EnuPan0_norw_4->GetMean();
Mean_EnuPan0_norw.at(4)=Mean_EnuPan0_norw_5->GetMean();
Mean_EnuPan0_norw.at(5)=Mean_EnuPan0_norw_6->GetMean();
Mean_EnuPan0_norw.at(6)=Mean_EnuPan0_norw_7->GetMean();
Mean_EnuPan0_norw.at(7)=Mean_EnuPan0_norw_8->GetMean();
Mean_EnuPan0_norw.at(8)=Mean_EnuPan0_norw_9->GetMean();
Mean_EnuPan0_norw.at(9)=Mean_EnuPan0_norw_10->GetMean();
Mean_EnuPan0_norw.at(10)=Mean_EnuPan0_norw_11->GetMean();
Mean_EnuPan0_norw.at(11)=Mean_EnuPan0_norw_12->GetMean();
Mean_EnuPan0_norw.at(12)=Mean_EnuPan0_norw_13->GetMean();

Mean_EnuDL_norw.at(0)=Mean_EnuDL_norw_1->GetMean();
Mean_EnuDL_norw.at(1)=Mean_EnuDL_norw_2->GetMean();
Mean_EnuDL_norw.at(2)=Mean_EnuDL_norw_3->GetMean();
Mean_EnuDL_norw.at(3)=Mean_EnuDL_norw_4->GetMean();
Mean_EnuDL_norw.at(4)=Mean_EnuDL_norw_5->GetMean();
Mean_EnuDL_norw.at(5)=Mean_EnuDL_norw_6->GetMean();
Mean_EnuDL_norw.at(6)=Mean_EnuDL_norw_7->GetMean();
Mean_EnuDL_norw.at(7)=Mean_EnuDL_norw_8->GetMean();
Mean_EnuDL_norw.at(8)=Mean_EnuDL_norw_9->GetMean();
Mean_EnuDL_norw.at(9)=Mean_EnuDL_norw_10->GetMean();
Mean_EnuDL_norw.at(10)=Mean_EnuDL_norw_11->GetMean();
Mean_EnuDL_norw.at(11)=Mean_EnuDL_norw_12->GetMean();
Mean_EnuDL_norw.at(12)=Mean_EnuDL_norw_13->GetMean();

//std::cout<<" count_1 is  "<<count_1<<" count_2 "<<count_2<<" count_3 "<<count_3<<" count_4 "<<count_4<<std::endl;
for (int i=0;i<13;i++)
{
 Mean_EnuWC_diff[i]=Mean_True.at(i)-Mean_EnuWC.at(i);
 Mean_EnuPanN_diff[i]=Mean_True.at(i)-Mean_EnuPanN.at(i);
 Mean_EnuPan0_diff[i]=Mean_True.at(i)-Mean_EnuPan0.at(i);
 Mean_EnuDL_diff[i]=Mean_True.at(i)-Mean_EnuDL.at(i);
 
 Mean_EnuWC_norw_diff[i]=Mean_True.at(i)-Mean_EnuWC_norw.at(i);
 Mean_EnuPanN_norw_diff[i]=Mean_True.at(i)-Mean_EnuPanN_norw.at(i);
 Mean_EnuPan0_norw_diff[i]=Mean_True.at(i)-Mean_EnuPan0_norw.at(i);
 Mean_EnuDL_norw_diff[i]=Mean_True.at(i)-Mean_EnuDL_norw.at(i);
 
 Mean_True_a[i]=Mean_True.at(i);
 std::cout<<" WC is "<<Mean_EnuWC.at(i)<<" WC_norw is "<<Mean_EnuWC_norw.at(i)<<" pan0 is "<<Mean_EnuPan0.at(i)<<" pan0_norw is "<<Mean_EnuPan0_norw.at(i)<<" PanN is "<<Mean_EnuPanN.at(i)<<" PanN_norw is "<<Mean_EnuPanN_norw.at(i)<<" DL is "<<Mean_EnuDL.at(i)<<" DL_norw is "<<Mean_EnuDL_norw.at(i)<<" True energy is "<<Mean_True.at(i)<<std::endl;
...
//***********************************************************************************************************************************************//
//******************************************Reweighting_GiBBU_to_GENIE_NOT_REWEIGHTED************************************************************//
//***********************************************************************************************************************************************//
for (int l=0;l<60;l++)
	{
					//CCQE//
	EnuWC_CCQE_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuWC_CCQE_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][0]);
	EnuPan0_CCQE_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuPan0_CCQE_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][0]);
	EnuPanN_CCQE_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuPanN_CCQE_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][0]);
	EnuDL_CCQE_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuDL_CCQE_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][0]);
	
					//CCMEC//
	EnuWC_CCMEC_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuWC_CCMEC_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][1]);
	EnuPan0_CCMEC_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuPan0_CCMEC_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][1]);
	EnuPanN_CCMEC_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuPanN_CCMEC_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][1]);
	EnuDL_CCMEC_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuDL_CCMEC_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][1]);
	
					//CCRES//				
	EnuWC_CCRES_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuWC_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][2]);
	EnuPan0_CCRES_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuPan0_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][2]);
	EnuPanN_CCRES_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuPanN_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][2]);
	EnuDL_CCRES_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuDL_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][2]);
	
					//CCDIS//
	EnuWC_CCDIS_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuWC_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][3]);
	EnuPan0_CCDIS_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuPan0_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][3]);
	EnuPanN_CCDIS_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuPanN_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][3]);
	EnuDL_CCDIS_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuDL_CCRES_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][3]);
	
					//CCCOH//
	EnuWC_CCCOH_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuWC_CCCOH_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][4]);
	EnuPan0_CCCOH_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuPan0_CCCOH_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][4]);
	EnuPanN_CCCOH_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuPanN_CCCOH_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][4]);
	EnuDL_CCCOH_GiBBU_GENIE_norw->SetBinContent(l+1,(EnuDL_CCCOH_GiBBUnorw->GetBinContent(l+1))*Reweighting_Gibbu_Genie_norw[l][4]);
