...
TH1D* highest_energy_proton = new TH1D("highest_energy_proton","highest_energy_proton",10,0,5);
...
/////////////////////////////////////////Calculating the momentum of final state 
...
double energy_neutrino_1(double M_Proton,double E_Muon,double M_Muon,double P_Muon, double Cosine_Muon)
{
  double E_neutrino=0;
...
double energy_neutrino_2(double M_delta,double M_Proton,double E_Muon,double M_Muon, double Cosine_Muon)
{
 double E_neutrino=0;
 E_neutrino= (pow(M_delta,2.0)-pow(M_Proton,2.0)+(2*M_Proton*E_Muon))/(2*(M_Proton-(E_Muon*(1-Cosine_Muon))));
 return E_neutrino;
}
double energy_neutrino_3(double Missing_PT, vector<double> M_Px[],vector<double> M_Py[],vector<double> M_Pz[],double Mu_E)
{
...
//...............................................................................................................................................//
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      //.............................................Finding the reconstructed neutrino energy.................................//
      //.......................................................................................................................//
      //.......................................................................................................................//
      
      
      double muon_neutrino_1=energy_neutrino_1(proton_mass,lepOut_E,muon_mass,muon_momentum,cos_theta(lepOut_Px, lepOut_Py,lepOut_Pz));
      Resolution_EnuCCQE_GiBBU->Fill(lepIn_E,lepIn_E-muon_neutrino_1);
      
      double muon_neutrino_2=energy_neutrino_2(mass_delta,proton_mass,lepOut_E,muon_mass,cos_theta(lepOut_Px, lepOut_Py,lepOut_Pz));
      //std::cout<<" energy "<<muon_neutrino_1<<std::endl;
      Resolution_EnuRes_GiBBU->Fill(lepIn_E,lepIn_E-muon_neutrino_2);
      
      //double muon_neutrino_3=energy_neutrino_3(Missing_PT(vi,Px,Py, lepOut_Px,lepOut_Py),Px,Py,Pz,lepOut_E);
      //Resolution_EnuCalo_GiBBU->Fill(lepIn_E,lepIn_E-muon_neutrino_3);
      
      
      
      //............................................Filling histogram for cosine_muon.........................................//
      //......................................................................................................................//
      //......................................................................................................................//
      ...
      //....................................making the histogram on the basis of the event type.................................//
      //........................................................................................................................//
      //........................................................................................................................//
      if (evType==1)
      {
      ...
      {
      TrueEnu_CCCOH_GiBBU->Fill(lepIn_E,weight);
      }
      else if (evType==33)
      {
      TrueEnu_CCCOH_GiBBU->Fill(lepIn_E,weight);
     ...
     //...............................................Getting the bins for the Truth Simulation......................................//
     //..............................................................................................................................//
     //..............................................................................................................................//
...
//..............................................This is where I create the smearing matrix( Smearing vector tbh:)..............................//
//.............................................................................................................................................//
//.............................................................................................................................................//   
string myText;
string data;
...
{ 
 ...
 while(std::getline(ss, data, ' '))
  {
  //std::cout<<" One word "<<stod(data)<<" and the integer is "<<j++<<std::endl;
...
//............................................Scalling the histograms.............................................................................//
//................................................................................................................................................//
//................................................................................................................................................//
double norm_GiBBU=cosine_muon->GetSumOfWeights(); 
double norm_GENIE=Resolution_EnuCCQE_GENIE->GetEntries();
...
TrueEnu_CCCOH_GENIE->Scale(1/norm_GENIE);
 					      ...
 					      //NOT REWEIGHTED//
TrueEnu_CCMEC_GENIEnorw->Scale(1/norm_GENIE);
TrueEnu_CCMEC_GENIEnorw->Scale(1/norm_GENIE);  
TrueEnu_CCRES_GENIEnorw->Scale(1/norm_GENIE);
TrueEnu_CCDIS_GENIEnorw->Scale(1/norm_GENIE);
TrueEnu_CCCOH_GENIEnorw->Scale(1/norm_GENIE);				      
...
TrueEnu_CCCOH_GiBBU->Scale(1/norm_GiBBU);

//............................................forming_the_reweighting_matrix_for_GiBBU(GENIE_REWEIGHTED)...........................................//
//.................................................................................................................................................//
//.................................................................................................................................................//

for (int i=0;i<60;i++)
{
std::cout<<" GiBBU "<<TrueEnu_CCQE_GiBBU->GetBinContent(i)<<" genie "<<TrueEnu_CCQE_GENIE->GetBinContent(i)<<std::endl;
//....................................................................CCQE........................................................................//
	if (TrueEnu_CCQE_GiBBU->GetBinContent(i)==0)
	{
	 Reweighting_Gibbu[i][0]=TrueEnu_CCQE_GENIE->GetBinContent(i);
	}
		else
		{
	 	 Reweighting_Gibbu[i][0]=TrueEnu_CCQE_GENIE->GetBinContent(i)/TrueEnu_CCQE_GiBBU->GetBinContent(i);
		}
	if (TrueEnu_CCMEC_GiBBU->GetBinContent(i)==0)
	{
	 Reweighting_Gibbu[i][1]=TrueEnu_CCMEC_GENIE->GetBinContent(i);
	}
		else
		{
	 	 Reweighting_Gibbu[i][1]=TrueEnu_CCMEC_GENIE->GetBinContent(i)/TrueEnu_CCMEC_GiBBU->GetBinContent(i);
		}
	if (TrueEnu_CCRES_GiBBU->GetBinContent(i)==0)
	{
	 Reweighting_Gibbu[i][2]=TrueEnu_CCRES_GENIE->GetBinContent(i);
	}
		else
		{
	 	 Reweighting_Gibbu[i][2]=TrueEnu_CCRES_GENIE->GetBinContent(i)/TrueEnu_CCRES_GiBBU->GetBinContent(i);
		}
	if (TrueEnu_CCDIS_GiBBU->GetBinContent(i)==0)
	{
	 Reweighting_Gibbu[i][3]=TrueEnu_CCDIS_GENIE->GetBinContent(i);
	}
		else
		{
	 	 Reweighting_Gibbu[i][3]=TrueEnu_CCDIS_GENIE->GetBinContent(i)/TrueEnu_CCDIS_GiBBU->GetBinContent(i);
		}
	if (TrueEnu_CCCOH_GiBBU->GetBinContent(i)==0)
	{
	 Reweighting_Gibbu[i][4]=TrueEnu_CCCOH_GENIE->GetBinContent(i);
	}
		else
		{
	 	 Reweighting_Gibbu[i][4]=TrueEnu_CCCOH_GENIE->GetBinContent(i)/TrueEnu_CCCOH_GiBBU->GetBinContent(i);
		}	
...
//............................................forming_the_reweighting_matrix_for_GiBBU(GENIE_NOT_REWEIGHTED).......................................//
//.................................................................................................................................................//
//.................................................................................................................................................//
...
//....................................................................CCQE........................................................................//
	if (TrueEnu_CCQE_GiBBU->GetBinContent(i)==0)
	{
	 Rewighting_Gibbu_Genie_norw[i][0]=TrueEnu_CCQE_GENIEnorw->GetBinContent(i);
	}
		else
		{
	 	 Rewighting_Gibbu_Genie_norw[i][0]=TrueEnu_CCQE_GENIEnorw->GetBinContent(i)/TrueEnu_CCQE_GiBBU->GetBinContent(i);
		}
//....................................................................CCMEC........................................................................//		
	if (TrueEnu_CCMEC_GiBBU->GetBinContent(i)==0)
	{
	 Rewighting_Gibbu_Genie_norw[i][1]=TrueEnu_CCMEC_GENIEnorw->GetBinContent(i);
	}
		else
		{
	 	 Rewighting_Gibbu_Genie_norw[i][1]=TrueEnu_CCMEC_GENIEnorw->GetBinContent(i)/TrueEnu_CCMEC_GiBBU->GetBinContent(i);
		}
//....................................................................CCRES........................................................................//		
	if (TrueEnu_CCRES_GiBBU->GetBinContent(i)==0)
	{
	 Rewighting_Gibbu_Genie_norw[i][2]=TrueEnu_CCRES_GENIEnorw->GetBinContent(i);
	}
		else
		{
...
//....................................................................CCDIS........................................................................//		
	if (TrueEnu_CCDIS_GiBBU->GetBinContent(i)==0)
	{
	 Rewighting_Gibbu_Genie_norw[i][3]=TrueEnu_CCDIS_GENIEnorw->GetBinContent(i);
		...
		{
	 	 Rewighting_Gibbu_Genie_norw[i][3]=TrueEnu_CCDIS_GENIEnorw->GetBinContent(i)/TrueEnu_CCDIS_GiBBU->GetBinContent(i);
		}
//....................................................................CCCOH........................................................................//		
	if (TrueEnu_CCCOH_GiBBU->GetBinContent(i)==0)
	{
	 Rewighting_Gibbu_Genie_norw[i][4]=TrueEnu_CCCOH_GENIEnorw->GetBinContent(i);
	}
		else
		{
	 	 Rewighting_Gibbu_Genie_norw[i][4]=TrueEnu_CCCOH_GENIEnorw->GetBinContent(i)/TrueEnu_CCCOH_GiBBU->GetBinContent(i);
		}	
...
legend->AddEntry(TrueEnu_CCQE_GENIE,"","f");
legend->AddEntry(TrueEnu_CCQE_GiBBU,"","f");
legend->Draw();
c1->cd(2);
TrueEnu_CCQE_ratio->Draw("Hist");
...
legend_1->AddEntry(TrueEnu_CCMEC_GENIE,"","f");
legend_1->AddEntry(TrueEnu_CCMEC_GiBBU,"","f");
legend_1->Draw();
c2->cd(2);
TrueEnu_CCMEC_ratio->Draw("Hist");
...
legend_2->AddEntry(TrueEnu_CCRES_GENIE,"","f");
legend_2->AddEntry(TrueEnu_CCRES_GiBBU,"","f");
legend_2->Draw();
c3->cd(2);
TrueEnu_CCRES_ratio->Draw("Hist");  
...
legend_3->AddEntry(TrueEnu_CCDIS_GENIE,"","f");
legend_3->AddEntry(TrueEnu_CCDIS_GiBBU,"","f");
legend_3->Draw();
c4->cd(2);
TrueEnu_CCDIS_ratio->Draw("Hist");        
...
TrueEnu_CCCOH_GENIE->Draw();
TrueEnu_CCCOH_GiBBU->Draw("SAME");
auto legend_4 = new TLegend(0.1,0.7,0.48,0.9);
legend_4->SetHeader("The Legend Title","C"); // option "C" allows to center the header
legend_4->AddEntry(TrueEnu_CCCOH_GENIE,"","f");
legend_4->AddEntry(TrueEnu_CCCOH_GiBBU,"","f");
legend_4->Draw();
c5->cd(2);
TrueEnu_CCCOH_ratio->Draw("Hist");              
      
      
      
//................................This is where I store the truth_bins that will be later to construct the reconstructed bins.................//
//............................................................................................................................................//
//............................................................................................................................................//
Truth_bins.push_back(bin_1->Integral());
Truth_bins.push_back(bin_2->Integral());
Truth_bins.push_back(bin_3->Integral());
Truth_bins.push_back(bin_4->Integral());
Truth_bins.push_back(bin_5->Integral());
Truth_bins.push_back(bin_6->Integral());
Truth_bins.push_back(bin_7->Integral());
Truth_bins.push_back(bin_8->Integral());
Truth_bins.push_back(bin_9->Integral());
Truth_bins.push_back(bin_10->Integral());
Truth_bins.push_back(bin_11->Integral());
Truth_bins.push_back(bin_12->Integral());
Truth_bins.push_back(bin_13->Integral());
Truth_bins.push_back(bin_14->Integral());
Truth_bins.push_back(bin_15->Integral());
Truth_bins.push_back(bin_16->Integral());
Truth_bins.push_back(bin_17->Integral());
Truth_bins.push_back(bin_18->Integral());
Truth_bins.push_back(bin_19->Integral());
Truth_bins.push_back(bin_20->Integral());
Truth_bins.push_back(bin_21->Integral());
Truth_bins.push_back(bin_22->Integral());
Truth_bins.push_back(bin_23->Integral());
Truth_bins.push_back(bin_24->Integral());
Truth_bins.push_back(bin_25->Integral());
Truth_bins.push_back(bin_26->Integral());
Truth_bins.push_back(bin_27->Integral());
Truth_bins.push_back(bin_28->Integral());
Truth_bins.push_back(bin_29->Integral());
Truth_bins.push_back(bin_30->Integral());
Truth_bins.push_back(bin_31->Integral());
Truth_bins.push_back(bin_32->Integral());
Truth_bins.push_back(bin_33->Integral());
Truth_bins.push_back(bin_34->Integral());
Truth_bins.push_back(bin_35->Integral());
Truth_bins.push_back(bin_36->Integral());
Truth_bins.push_back(bin_37->Integral());
Truth_bins.push_back(bin_38->Integral());
Truth_bins.push_back(bin_39->Integral());
Truth_bins.push_back(bin_40->Integral());
Truth_bins.push_back(bin_41->Integral());
Truth_bins.push_back(bin_42->Integral());

//...............................................Getting the reconstructed bins..................................................................//
//...............................................................................................................................................//
//...............................................................................................................................................//
double prod=0;
...
/*for (int i=0;i<42;i++)
{
std::cout<<" vector "<<Reconstructed_bins[i]<<std::endl;
}*/
