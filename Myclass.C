...
{ 
 ...
 while(std::getline(ss, data, ' '))
  {
  //std::cout<<" One word "<<stod(data)<<std::endl;
...
TLegend *l14 = new TLegend(0.50, 0.25, 0.9, 0.1);
  //l14 -> SetNColumns(2);
l14 -> AddEntry(hprof_EnuCCQE_GiBBU, "CCQE approach", "l");
l14 -> AddEntry(hprof_EnuCalo_GiBBU, "Calorimetry approach", "l");
l14 -> AddEntry(hprof_EnuRES_GiBBU, "Resonant approach", "l");
l14 -> Draw();
