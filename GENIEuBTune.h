...
// Mon Nov  1 16:30:50 2021 by ROOT version 6.24/04
// from TTree gst/GENIE Summary Event Tree
// found on file: merged_rw_events.gst.root
//////////////////////////////////////////////////////////

#ifndef GENIEuBTune_h
#define GENIEuBTune_h
...
#ifdef GENIEuBTune_cxx
GENIEuBTune::GENIEuBTune(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../merged_rw_events.gst.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../merged_rw_events.gst.root");
      }
...
GENIEuBTune::~GENIEuBTune()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t GENIEuBTune::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GENIEuBTune::LoadTree(Long64_t entry)
{
...
void GENIEuBTune::Init(TTree *tree)
{
...
void GENIEuBTune::Show(Long64_t entry)
{
...
Int_t GENIEuBTune::Cut(Long64_t entry)
{
